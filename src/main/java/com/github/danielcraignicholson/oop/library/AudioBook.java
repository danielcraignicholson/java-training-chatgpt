...
public class AudioBook extends LibraryItem implements Downloadable {
    ...
    public AudioBook(String title, String author, int yearPublished, int durationMinutes, String narrator) {
    ...
    public void download() {
        System.out.println("Downloading audiobook: " + getTitle() + " – Duration: " + durationMinutes + " minutes");
    }
